...
silent! normal! zE
let s:l = 652 - ((30 * winheight(0) + 23) / 46)
...
wincmd w
argglobal
if bufexists("~/cn-seamless/my-mill.ini") | buffer ~/cn-seamless/my-mill.ini | else | edit ~/cn-seamless/my-mill.ini | endif
balt remora.h
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
wincmd w
argglobal
terminal ++curwin ++cols=62 ++rows=46 
let s:term_buf_9 = bufnr()
balt ~/cn-seamless/my-mill.hal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
tabnext 1
badd +442 remora.c
badd +769 remora.c.old
badd +19 remora.h
badd +14 ~/cn-seamless/my-mill.hal
badd +53 ~/.vimrc
badd +48 ~/cn-seamless/my-mill.ini
